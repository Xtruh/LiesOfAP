...
- DLC is available as soon as you reach the Path of the Pilgrim Stargazer and have the Stars Chrysalis
...
2. Once in game press **Enter** or **/** to open the text client and connect by typing (/connect Server:Port Slotname password) if slot name contains spaces surround it in quotes "like this".
...
2. Set "LiesOfAP: 1" to 0 located in LiesofP\Content\Binaries\Win64(WinGDK)\ue4ss\Mod\mods.txt
